...
!function e(t, n, o) {
    ...
    2: [function(e, t, n) {
        (function(o, i) {
            !function(e, o) {
                ...
                function b(e, t, o) {
                    t.constructor === e.constructor && o === d && t.constructor.resolve === c ? m(e, t) : o === W ? (E(e, W.error),
                    W.error = null) : void 0 === o ? _(e, t) : n(o) ? p(e, t, o) : _(e, t)
                }
                function v(e, n) {
                ...
                function T(e, t, o, i) {
                    ...
                    if (r) {
                        ...
                        s = i,
                        d = !0;
                    t._state !== Y || (r && d ? v(t, s) : c ? E(t, a) : e === Q ? _(t, s) : e === V && E(t, s))
                }
                function S(e, t) {
                    try {
                        t(function(t) {
                ...
                var P = void 0
                  , L = P = Array.isArray ? Array.isArray : function(e) {
                ...
                var z = Math.random().toString(36).substring(2)
                  ...
                  , X = function() {
                    function e(e, t) {
                        ...
                        L(t) ? (this.length = t.length,
                        this._remaining = t.length,
                        this._result = new Array(this.length),
                        0 === this.length ? _(this.promise, this._result) : (this.length = this.length || 0,
                        this._enumerate(t),
                        0 === this._remaining && _(this.promise, this._result))) : E(this.promise, I())
                    }
        ...
        (function(global) {
            !function(e, t) {
                ...
                : function(e) {
                  ...
                  , re_btou = new RegExp(["[À-ß][-¿]", "[� -ï][-¿]{2}", "[ð-÷][-¿]{3}"].join("|"),"g")
                  , cb_btou = function(e) {
                    switch (e.length) {
                    case 4:
          ...
          , a = function() {
            ...
            return i(e, [{
                ...
                value: function() {
                    ...
                    localStorage.getItem("gd_tag") ? (c.innerHTML = "Revert Vast tag",
                    c.style.background = "#ff8c1c") : (c.innerHTML = "Demo VAST tag",
                    c.style.background = "#44a5ab"),
                    localStorage.getItem("gd_midroll") ? (u.innerHTML = "Revert delay",
                    u.style.background = "#ff8c1c") : (u.innerHTML = "Disable delay",
        ...
        var i = function() {
          ...
          , c = function() {
            function e(t, n, i) {
                ...
                ,
                this.userDeclinedPersonalAds = document.location.search.indexOf("gdpr-targeting=0") >= 0 || document.cookie.indexOf("ogdpr_advertisement=0") >= 0 ? "1" : "0",
                ...
                this.options.width = this.thirdPartyContainer ? this.thirdPartyContainer.offsetWidth : u,
                this.options.height = this.thirdPartyContainer ? this.thirdPartyContainer.offsetHeight : l,
                this.gameId = "0",
                this.category = "",
                this.tags = [],
            ...
            return i(e, [{
                ...
                value: function() {
                    ...
                    return new Promise(function(t, n) {
                        if (e.requestRunning)
                            (0,
                            a.dankLog)("AD_SDK_REQUEST", "A request is already running", "warning");
                        else {
                            e.requestRunning = !0,
                            ...
                            try {
                                localStorage.getItem("gd_debug") && localStorage.getItem("gd_tag") ? t(localStorage.getItem("gd_tag")) : e._tunnlReportingKeys().then(function(o) {
                                    ...
                                    var i = (o.nsid ? o.nsid : "TNL_T-17102571517") + "/" + (o.tid ? o.tid : "TNL_NS-18101700058");
                                    delete o.nsid,
                                    delete o.tid,
                                    (0,
                                    a.dankLog)("AD_SDK_AD_UNIT", i, "info");
                                    var r = o.consent_string ? o.consent_string : "BOWJjG9OWJjG9CLAAAENBx-AAAAiDAAA";
                                    Object.assign(o, {
                                        tnl_system: "1",
                ...
                value: function() {
                    ...
                    return new Promise(function(t) {
                        var n = "";
                        n = !navigator.userAgent.match(/Crosswalk/i) && void 0 === window.cordova || "m.hopy.com" !== s.getParentDomain ? "page_url=" + encodeURIComponent(e.parentUrl) : "bundle=com.hopy.frivgames";
                        var o = (0,
                        s.getMobilePlatform)()
                          , i = 1 === e.adTypeCount ? "preroll1" : "midroll" + e.adCount.toString()
                          , r = (0,
                        s.getQueryString)("ch", window.location.href)
                          , a = (0,
                        s.getQueryString)("ch_date", window.location.href)
                          , d = r ? "&ch=" + r : ""
                          , c = a ? "&ch_date=" + a : ""
                          , u = "https://pub.tunnl.com/opphb?" + n + "&player_width=" + e.options.width + "&player_height=" + e.options.height + "&ad_type=video_image&os=" + o + "&game_id=" + e.gameId + "&ad_position=" + i + d + c + "&correlator=" + Date.now()
                          , l = new Request(u,{
                            method: "GET"
                        });
                ...
                value: function(e) {
                    if ("undefined" != typeof google)
                        try {
                            ...
                            if (t.adTagUrl = e,
                            (0,
                            a.dankLog)("AD_SDK_TAG_URL", t.adTagUrl, "success"),
                            ...
                            void 0 !== window.ga) {
                                ...
                                window.ga("gd.send", {
                                    ...
                                    eventAction: this.parentDomain + " | h" + o + " d" + i + " m" + r + " y" + s,
                                    eventLabel: e
                                })
                            }
                ...
                value: function() {
                    ...
                    setTimeout(function() {
                        ...
                        e.thirdPartyContainer && (e.thirdPartyContainer.style.transform = "translateX(-9999px)",
                ...
                value: function() {
                    ...
                    this.thirdPartyContainer ? (this.adContainer.appendChild(n),
                    this.thirdPartyContainer.appendChild(this.adContainer)) : (this.adContainer.appendChild(n),
                    ...
                    window.addEventListener("resize", function() {
                        ...
                        e.options.width = e.thirdPartyContainer ? e.thirdPartyContainer.offsetWidth : t,
                        e.options.height = e.thirdPartyContainer ? e.thirdPartyContainer.offsetHeight : o,
                ...
                value: function(e) {
                    ...
                    case google.ima.AdEvent.Type.CLICK:
                        a = "CLICK",
                        d = "Fired when the ad is clicked.";
                        break;
                    ...
                    case google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED:
                        ...
                        this._hide(),
                        this.adsLoaderPromise.then(function() {
                            if (t.adsLoader && t.adsLoader.contentComplete(),
                    ...
                    case google.ima.AdEvent.Type.LOADED:
                        a = "LOADED",
                        d = e.getAd().getContentType();
                        break;
                    case google.ima.AdEvent.Type.LOG:
                        e.getAdData().adError && (a = "LOG",
                        d = e.getAdData());
                        break;
                ...
                value: function(e, t) {
                    var n = this;
                    (0,
                    a.dankLog)("AD_SAFETY_TIMER", "Invoked timer from: " + t, "success"),
                ...
                value: function(e) {
                    if (void 0 !== this.safetyTimer && null !== this.safetyTimer && ((0,
                    a.dankLog)("AD_SAFETY_TIMER", "Cleared timer set at: " + e, "success"),
                ...
                value: function(e, t, n) {
                    ...
                    googletag.cmd.push(function() {
                        var i = [];
                        i[0] = googletag.defineSlot("/1015413/Gamedistribution_ingame_1x1_crosspromo", [1, 1], o.prefix + "baguette").setCollapseEmptyDiv(!0, !0).addService(googletag.pubads()),
    ...
    11: [function(e, t, n) {
        ...
        : function(e) {
          ...
          , r = "object" === ("undefined" == typeof GD_OPTIONS ? "undefined" : o(GD_OPTIONS)) && GD_OPTIONS ? GD_OPTIONS : window.gdApi && "object" === o(window.gdApi.q[0][0]) && window.gdApi.q[0][0] ? window.gdApi.q[0][0] : {};
        ...
        var a = o(e("../package.json"))
          ...
          , p = function() {
            function e(t) {
                ...
                this.options = t ? (0,
                g.extendDefaults)(o, t) : o;
                var r = a.default.version
                  , s = console.log("%c %c %c GameDistribution.com HTML5 SDK | Version: " + r + " %c %c %c", "background: #9854d8", "background: #6c2ca7", "color: #fff; background: #450f78;", "background: #6c2ca7", "background: #9854d8", "background: #ffffff");
                ...
                if (this._analytics(m, p),
                ["razda.com", "74.127.72.247"].indexOf(p) > -1)
                    return void 0 !== window.ga && window.ga("gd.send", {
                        hitType: "event",
                        eventCategory: "SDK_BLOCKED",
                        eventAction: p,
                        eventLabel: this.options.gameId + ""
                    }),
                    void (document.location = "/blocked.html?domain=" + p + "&localTime=" + (new Date).getHours());
                var b = [];
                this.options.testing = this.options.testing || b.indexOf(p) > -1,
                this.options.testing && (0,
                h.dankLog)("SDK_TESTING_ENABLED", this.options.testing, "info"),
                this.whitelabelPartner = !1;
                var v = (0,
                g.getQueryParams)("xanthophyll");
                v.hasOwnProperty("xanthophyll") && "true" === v.xanthophyll && (this.whitelabelPartner = !0,
                (0,
                h.dankLog)("SDK_WHITELABEL", this.whitelabelPartner, "success"));
                try {
                    if ("developer.gamedistribution.com" === p) {
                        ...
                        "html5.api.gamedistribution.com" !== p && "localhost:3000" !== p || (localStorage.setItem("gd_debug", "true"),
                        localStorage.setItem("gd_midroll", "0"));
                    localStorage.getItem("gd_debug") && this.openConsole()
                } catch (e) {
                    console.log(e)
                }
                (new Image).src = "https://ana.tunnl.com/event?page_url=" + encodeURIComponent(u) + "&game_id=" + this.options.gameId + "&eventtype=1",
                ...
                this.eventBus.subscribe("CONTENT_RESUME_REQUESTED", function(e) {
                    ...
                    "developer.gamedistribution.com" === p || !0 === new RegExp("^localhost").test(p)) {
                ...
                this.videoAdInstance = new d.default(this.options.flashSettings.adContainerId,this.options.prefix,this.options.advertisementSettings);
                var y = new Promise(function(e) {
                    var t = {
                      ...
                      , o = "https://game.api.gamedistribution.com/game/get/" + t.gameId.replace(/-/g, "") + "/?domain=" + p + "&localTime=" + (new Date).getHours()
                      , i = new Request(o,{
                        method: "GET"
                    });
                    fetch(i).then(function(e) {
                        ...
                        if (o.error)
                            (0,
                            h.dankLog)("SDK_GAME_DATA_READY", o.error, "warning");
                        else if (o.success) {
                            var i = {
                                ...
                                displaySecondPrerollIfFirstOneShort: o.result.game.displaySecondPrerollIfFirstOneShort
                            };
                            (t = (0,
                            g.extendDefaults)(t, i)).displaySecondPrerollIfFirstOneShort && (n.videoAdInstance.maxPrerollCount = 2),
                            (0,
                            h.dankLog)("SDK_GAME_DATA_READY", t, "success")
                        }
                        e(t)
                    }).catch(function(n) {
                        (0,
                        h.dankLog)("SDK_GAME_DATA_READY", n, "success"),
                        e(t)
                    })
                }
                );
                y.then(function(e) {
                    ...
                    try {
                        localStorage.getItem("gd_debug") && (localStorage.getItem("gd_tag") && (n.videoAdInstance.tag = localStorage.getItem("gd_tag")),
                        localStorage.getItem("gd_midroll") && (e.midroll = localStorage.getItem("gd_midroll")))
                    } catch (e) {
                        console.log(e)
                    }
                    if (e.advertisements) {
            ...
            return s(e, [{
                ...
                value: function(e) {
                    var t = document.location.search.indexOf("gdpr-tracking") >= 0
                      ...
                      , o = ""
                      , i = "";
                    t ? n ? (o = "General Data Protection Regulation is set to allow tracking.",
                    i = "success") : (o = "General Data Protection Regulation is set to disallow tracking.",
                    i = "warning") : (o = "General Data Protection Regulation consent for tracking is not set by the publisher.",
                    i = "warning"),
                    ...
                    var r = document.location.search.indexOf("gdpr-targeting") >= 0
                      ...
                      , a = ""
                      , d = "";
                    r ? s ? (a = "General Data Protection Regulation is set to allow personalised advertisements.",
                    d = "success") : (a = "General Data Protection Regulation is set to disallow personalised advertisements.",
                    d = "warning") : (a = "General Data Protection Regulation consent for targeting is not set by the publisher.",
                    d = "warning"),
                    ...
                    var c = document.location.search.indexOf("gdpr-third-party") >= 0
                      ...
                      , l = ""
                      , h = "";
                    c ? u ? (l = "General Data Protection Regulation is set to allow third parties.",
                    h = "success") : (l = "General Data Protection Regulation is set to disallow third parties.",
                    h = "warning") : (l = "General Data Protection Regulation consent for third parties is not set by the publisher.",
                    h = "warning"),
                ...
                value: function(e) {
                    (0,
                    h.dankLog)(e.name, e.message, e.status);
                    try {
                ...
                value: function(e, t) {
                    var n = this;
                    (0,
                    g.getScript)("https://www.google-analytics.com/analytics.js", "gdsdk_google_analytics").then(function() {
                        ...
                        (0,
                        h.dankLog)("SDK_LOAD_SCRIPT", e, "error")
                    }),
                    e || (0,
                    g.getScript)("https://tags.crwdcntrl.net/c/13998/cc.js?ns=_cc13998", "LOTCC_13998").then(function() {
                        n.readyPromise.then(function(e) {
                            "object" === r(window._cc13998) && "function" == typeof window._cc13998.bcpf && "function" == typeof window._cc13998.bcpw && (window._cc13998.bcpw("act", "play"),
                            window._cc13998.bcpw("int", "domain : " + t),
                            window._cc13998.bcpw("int", "category : " + e.category.toLowerCase()),
                ...
                value: function(e, t) {
                    ...
                    t ? document.getElementById(this.options.prefix + "splash-button").addEventListener("click", function() {
                        ...
                        document.cookie = "ogdpr_tracking=1; expires=" + e.toUTCString() + "; path=/",
                        n.showBanner()
                    }) : d.addEventListener("click", function() {
                        n.showBanner()
                    }),
                    ...
                    this.eventBus.subscribe("CONTENT_PAUSE_REQUESTED", function() {
                        d && d.parentNode ? d.parentNode.removeChild(d) : d && (d.style.display = "none"),
                        c && c.parentNode ? c.parentNode.removeChild(c) : c && (c.style.display = "none")
                    }),
                ...
                value: function() {
                    var e = this;
                    this.videoAdInstance.canRequestPreroll() && (this.videoAdInstance.requestedPrerollCount++,
                    this.videoAdInstance.requestAttempts = 0,
                    this.videoAdInstance.requestAd().then(function(t) {
                ...
                value: function() {
                    ...
                    this.readyPromise.then(function(t) {
                        t.advertisements && !e.whitelabelPartner ? void 0 !== e.adRequestTimer ? (new Date).valueOf() - e.adRequestTimer.valueOf() < t.midroll ? ((0,
                        h.dankLog)("SDK_SHOW_BANNER", "The advertisement was requested too soon after the previous advertisement was finished.", "warning"),
                        e.onResumeGame("Just resume the game...", "success")) : ((0,
                        h.dankLog)("SDK_SHOW_BANNER", "Requested the midroll advertisement.", "success"),
                        ...
                        e.msgrt.send("req.ad.midroll." + e.videoAdInstance.requestedMidrollCount)) : ((0,
                        h.dankLog)("SDK_SHOW_BANNER", "Requested the preroll advertisement.", "success"),
                        e.adRequestTimer = new Date,
                        e.videoAdInstance.requestAttempts = 0,
                        ...
                        e.msgrt.send("req.ad.preroll." + e.videoAdInstance.requestedPrerollCount)) : (e.videoAdInstance.cancel(),
                        (0,
                        h.dankLog)("SDK_SHOW_BANNER", "Advertisements are disabled.", "warning"))
                    }).catch(function(e) {
                        (0,
                        h.dankLog)("SDK_SHOW_BANNER", e, "error")
                    })
                }
            }, {
                key: "customLog",
    ...
    13: [function(e, t, n) {
        ...
        function i() {
            ...
            }, i = window.location.search.substring(1), r = {}; e = n.exec(i); )
                r[o(e[1])] = o(e[2]);
            return r
        }
        function r(e) {
        ...
        n.getParentUrl = function() {
            ...
            if (e.gd_sdk_referrer_url)
                return console.log("self-hosted referrer URL:", e.gd_sdk_referrer_url),
            ...
            if (-1 !== document.referrer.indexOf("gameplayer.io")) {
                ...
                if (n) {
                    var r = n;
                    "" !== r && "{portal%20name}" !== r && "{spilgames}" !== r && "{portal name}" !== r && (t = "https://" + (t = (r = s(r)).replace(/^(?:https?:\/\/)?(?:\/\/)?/i, "")))
                }
                console.info("Spil referrer URL: " + t)
            } else
                -1 !== document.referrer.indexOf("localhost") && (t = "https://gamedistribution.com/");
            return t
        }
        ,
        n.getParentDomain = function() {
            ...
            if (-1 !== document.referrer.indexOf("gameplayer.io")) {
                ...
                if (n) {
                    var r = n;
                    "" !== r && "{portal%20name}" !== r && "{spilgames}" !== r && "{portal name}" !== r && (t = (r = s(r)).replace(/^(?:https?:\/\/)?(?:\/\/)?(?:www\.)?/i, "").split("/")[0])
                }
                console.info("Spil referrer domain: " + t)
            } else
                -1 !== document.referrer.indexOf("localhost") && (t = "gamedistribution.com");
            return t
        }
        ,
        n.getQueryParams = i,
            ...
            try {
                if (localStorage.getItem("gd_debug")) {
                    var i = "error" === n ? "background: #c4161e; color: #fff" : "warning" === n ? "background: #ff8c1c; color: #fff" : "info" === n ? "background: #ff0080; color: #fff" : "background: #44a5ab; color: #fff"
                      , r = console.log("[" + (Date.now() - o) / 1e3 + "s]%c %c %c gdsdk %c %c %c " + e + " ", "background: #9854d8", "background: #6c2ca7", "color: #fff; background: #450f78;", "background: #6c2ca7", "background: #9854d8", i, void 0 !== t ? t : "");
